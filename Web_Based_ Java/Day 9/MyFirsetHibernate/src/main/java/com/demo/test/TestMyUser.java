...
public class TestMyUser {
	...
	public static void main(String[] args) {
		...
		MyUser u1=new MyUser(23,"Kishori", "kkk@gmail.com");
		MyUser u2=new MyUser(24,"Anil", "aaa@gmail.com");
		Product p1=new Product("pen", 10, 10);
		Product p2=new Product("pencil", 10, 10);
